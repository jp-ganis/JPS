...
elseif (UnitExists("focus")==1 and UnitIsEnemy("player","focus")==1) then
	...
	if jps.canHeal("target") and UnitIsFriend("player","target") then table.insert(Tanktable,"target") end
	if jps.canHeal("focus") and UnitIsFriend("player","focus")==1 then table.insert(Tanktable,"focus") end
	local lowestHP = 1
