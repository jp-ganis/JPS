...
hunter.spells["serpentSting"] = toSpellName(87935)
...
hunter.spells["explosiveTrap"] = toSpellName(82939)
hunter.spells["iceTrap"] = toSpellName(82941)
hunter.spells["freezingTrap"] = toSpellName(60192)
...
hunter.spells["bindingShot"] = toSpellName(109248)
hunter.spells["focusingShot"] = toSpellName(163485)
...
function hunter.petShouldAttackMyTarget()
    ...
    and UnitCanAttack("player", "target") == true then        -- 3) check that player can attack current target
        return true
    end
    return false
end
