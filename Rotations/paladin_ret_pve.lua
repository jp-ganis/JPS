...
{"nested", 'not jps.MultiTarget', {
   ...
   { paladin.spells.templarsVerdict,       'paladin.cp() > 4' },
...
{"nested",'jps.Defensive',{
   ...
   {"nested", 'not jps.MultiTarget', {
   { paladin.spells.executionSentence,      'jps.TimeToDie("target") > 12' },
   { paladin.spells.holyAvenger,          'jps.buff(paladin.spells.seraphim)' },
   { paladin.spells.holyAvenger,           'paladin.cp() <= 2 and jps.talentInfo(paladin.spells.seraphim)' },
   { paladin.spells.avengingWrath,       'jps.buff(paladin.spells.seraphim)' },
   { paladin.spells.avengingWrath,       'jps.talentInfo(paladin.spells.seraphim)' },
